---
title: "Legacy Products Access"
description: "Access Sintra Bots, Prompts, Add-ons, and legacy Helpers from the legacy platform section."
---

Legacy products include Sintra Bots, Sintra Prompts, Add-ons, and the legacy version of Sintra Helpers. All of these products were available for purchase at trysintra.com, which has since been closed.
...
In order to start using Sintra Bots, you would need to create a[ make.com](http://make.com/) account first. This can be done free of charge and Make is free to use for up to 1,000 operations per month. Once you go above that, you only pay per the operations you use to Make: [www.make.com/en/pricing](https://www.make.com/en/pricing)

Additionally, you should have access to OpenAI API credits to use the GPT model of your preference in the bot configuration. Credits are available for purchase at [platform.openai.com/account/billing/overview](https://platform.openai.com/account/billing/overview).
