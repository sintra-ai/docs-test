---
title: "Login to Sintra for the first time"
description: "In this article, we’ll cover what you need to know when logging in to the Sintra App for the first time, how to log in later on, and how to troubleshoot the ..."
---
