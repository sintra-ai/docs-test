---
title: "Navigation bar in the web app"
description: "Learn how to navigate the Sintra AI web app and use its features."
---

The web app features a simple design with easy access to main features through the left-side menu. 
