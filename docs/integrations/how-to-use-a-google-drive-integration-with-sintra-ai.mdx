...
description: "Save files to Google Drive and upload from Drive to helper chats."
---

The Google Drive integration allows 2 actions:

  * saving to Google Drive

  * uploading files to Brain AI or Helper chats from Google Drive instead of your device
