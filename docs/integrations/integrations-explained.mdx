...
description: "Connect third-party tools and platforms to enable helpers with extended capabilities."
---

While Sintra does not provide API capabilities, which means there are no available API keys that can be used to connect to other services or platforms, Sintra supports multiple integrations within the app itself. Integrations allow your Sintra Helpers to connect with third-party tools, retrieve data, and complete tasks on your behalf. 
