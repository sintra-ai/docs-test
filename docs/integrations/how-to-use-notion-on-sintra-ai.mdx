...
description: "To start using Notion with Sintra, you will have to connect the integration first. Follow this guide to connect your Notion workspace to Sintra:"
---
