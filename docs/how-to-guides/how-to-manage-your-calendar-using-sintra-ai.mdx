...
description: "Learn how to create, read, and manage calendar events using Sintra AI."
---

First, connect your calendar integrations. Sintra supports these calendar platforms:
