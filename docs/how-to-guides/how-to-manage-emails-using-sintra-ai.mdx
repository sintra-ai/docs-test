...
description: "To start managing your mail inbox with Sintra, you will have to connect the email integrations first. Currently, Sintra supports these email platforms:"
---
