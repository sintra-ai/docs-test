...
description: "Create up to 5 different Brain AI profiles for various projects or clients."
---

Brain AI profiles are like special libraries filled with all the important information about your business and connections to integrated apps. When you add these knowledge bases to your Sintra AI profile, the Helpers can use these resources to provide in-touch and effective assistance and bring automation to the next level.
...
**Tip** : to delete a Brain AI profile, select the cogwheel icon in the top-right corner of your Brain AI profile card at [app.sintra.ai/brain](https://app.sintra.ai/brain), then choose the bin button in the pop-up menu. Deleted profiles cannot be retrieved.