...
description: "Working environments for organizing projects, clients, or businesses in Sintra."
---

When you start out using Sintra - you will be guided through an onboarding, during which, information on your business or project is collected and stored in a workspace. The first workspace is created by default. Let's dive into what Sintra workspaces are, what types of workspaces exist and how to utilize them!
